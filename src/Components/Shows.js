        ...
        return (
            <Grid>
                ...
                <Row className="show-row">
                        <Col xs={12} sm={6} md={3}>Old Time Honey, Paris Pick & Francesca Mirai</Col>
                        <Col xs={12} sm={6} md={3}>Sunday October 27th, 2019</Col>
                        <Col xs={12} sm={6} md={3}>Quai des Brumes, Montreal</Col>
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://parispickandthepricks.com/">Event Info</Button>
                        </Col>
                    </Row>
                <Row className="show-row">
                        <Col xs={12} sm={6} md={3}>Old Time Honey, North by North, The Lonely Whiners & Tugawar</Col>
                        <Col xs={12} sm={6} md={3}>Friday September 20th, 2019</Col>
                        <Col xs={12} sm={6} md={3}>L'Escogriffe, Montreal</Col>
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/events/2506256706093247/">Event Info</Button>
                        </Col>
                    </Row>
                <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/FRINGEmtl/">Event Info</Button>
                        </Col>
                    </Row>
                    <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/irenespub.ca/">Event Info</Button>
                        </Col>
                    </Row>
                <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/events/2477389098940827/">Event Info</Button>
                        </Col>
                    </Row>
                <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/events/1483943208404221/">Event Info</Button>
                        </Col>
                    </Row>
                    <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/ChickPickinMondays/?ref=bookmarks">Event Info</Button>
                        </Col>
                    </Row>
                <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://folkconference.org/">Event Info</Button>
                        </Col>
                    </Row>
                <Row className="show-row">
                        <Col xs={12} sm={6} md={3}>Folk Alliance International Showcases</Col>
                ...
                <Row className="show-row">
                    ...
                    <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>Coop Katacombs, 1635 St Laurent Blvd, Montreal</Col>
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/events/191449174843350/">Event Info</Button>
                        </Col>
                    </Row>
                    <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                            <Button bsStyle="default btn-shows" href="https://www.facebook.com/events/949198781919566/">Event Info</Button>
                        </Col>
                    </Row>
                    <Row className="show-row">
                        ...
                        <Col xs={12} sm={6} md={3}>
                                <Button bsStyle="default btn-shows" href="https://www.facebook.com/events/234095787326463/">Event Info</Button>
                        </Col>
                    </Row>
                    <Row className="show-row">
